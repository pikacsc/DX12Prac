...
bool InitD3D()
{
	...
	*/
	...
	an alignment of 64KB. We are creating 3 resources, So with a float being 4 bytes, we have
...
void Update()
{
	...
	XMMATRIX transposed = XMMatrixTranspose(wvpMat); // must transpose wvp matrix in constant buffer
	...
	rotMat = rotMat * (XMLoadFloat4x4(&cube2RotMat) * (rotXMat * rotYMat));
